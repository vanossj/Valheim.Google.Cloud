...
- [How to run Valheim Server in Google Cloud (90 days free trial)](#how-to-run-valheim-server-in-google-cloud-90-days-free-trial)
- [Table of contents](#table-of-contents)
  ...
  - [Optional: Shutdown VM when after all players leave](#optional-shutdown-vm-when-after-all-players-leave)
...
## Optional: Shutdown VM when after all players leave
...
- tail the valheim monitor logs: `journalctl -u valheim-monitor.service -f`
